const Constants = require('2pitCore/model/CONSTANTS');
const Database = require('2pitUtilities/' + Constants.DB_MANAGER);
...
exports.select = function (context, connection, table, where, { columns = null, order = null, joins = null } = {}) 
{
  return new Promise ( (resolve, reject) => {
    ...
    return Database.select(connection, table, where, { columns: columns , order: order, joins: joins })
