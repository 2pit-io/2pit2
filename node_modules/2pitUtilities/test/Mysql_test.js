...
assert.equal(mysql.not().lt('property', 'aa').serialize(), '(NOT property < "aa")');
assert.equal(mysql.and().ge('property1', 'aa').lt('property2', -1).serialize(), '(property1 >= "aa" AND property2 < "-1")');
